...
public class TransferController {
    ...
    @GetMapping("/cruising-sailing")
    public String showCruisingSailing() {
        return "cruising-sailing";
    }

    @GetMapping("/museums")
    public String showMuseums() {
        return "museums";
    }

    @GetMapping("/ecotourism-nature")
    public String showEcotourismNature() {
        return "ecotourism-nature";
    }
    ...
    // Grand Museum Mapping
    @GetMapping("/grandMuseum")
    public String showGrandMuseum() {
        return "grandMuseum";
    }
